...
def main():
    ...
    mo, d, h, mi = cal(aos)
    z2, z3, h2, m2 = cal(los)
    print("AOS %02d:%02d LOS %02d:%02d" % (h, mi, h2, m2))
    print("MaxEl %.0f Dur %dm" % (mel * RAD, round((los - aos) * 1440.0)))
    print("UTC    Az  El  Rng")
    t = aos
    while t <= los + 0.000000001:
        ...
        if el < 0:
            el = 0.0
        zz, z4, hh, mm2 = cal(t)
        print("%02d:%02d %3.0f %3.0f %5.0f" % (hh, mm2, az * RAD, el * RAD, rng))
        t = t + step / 86400.0
